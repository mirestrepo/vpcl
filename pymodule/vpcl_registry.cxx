...
{
  vpcl_register::register_process();
  Py_INCREF(Py_None);
  return Py_None;
}
...
initpy_vpcl(void)
{
  ...
  py_vpcl_methods[0]=reg_pro;
  py_vpcl_methods[1]=reg_data;
  
  for (int i=0; i<METHOD_NUM; ++i) {
    py_vpcl_methods[i+2]=batch_methods[i];
  }
  
  Py_InitModule("py_vpcl", py_vpcl_methods);
}
