...
Python bindings for vpcl utilities processes
"""
...
#  Export .ply to .pcd
#********************************************************************
def ply2pcd(ply_file, pcd_file, point_type="PointNormal", binary=False):
  py_vpcl.init_process("vpcl_ply2pcd_process");
  py_vpcl.set_input_string(0, ply_file);
  py_vpcl.set_input_string(1, pcd_file);
  py_vpcl.set_input_string(2, point_type);
  py_vpcl.set_input_bool(3, binary);
  return py_vpcl.run_process();